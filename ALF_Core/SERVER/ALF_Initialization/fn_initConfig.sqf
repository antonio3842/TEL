...
*/
ALF_Blackmarket = "21rima-sh0p.onion"; //DN1 - Weed
publicVariable "ALF_Blackmarket";
ALF_Blackmarket2 = "1rama-shop.onion"; //Graine
publicVariable "ALF_Blackmarket2";
ALF_Blackmarket3 = "3rama-sh0p.onion"; //Armes de Poing
publicVariable "ALF_Blackmarket3";
ALF_Blackmarket4 = "heav-sh0p.onion"; //Armes Lourde
publicVariable "ALF_Blackmarket4";
ALF_Blackmarket5 = "tuvcs-axtbunk.onion"; //Livraison aérienne crime
publicVariable "ALF_Blackmarket5";
ALF_Blackmarket6 = "c0c0-mduwaef.onion"; //Cocaine
publicVariable "ALF_Blackmarket6";
...
ALF_Mobiliers_Objects_Data = ["alf_objects\table_weed\table_weed.p3d","alf_objects\alf_p_weed\alf_plante_w_2.p3d","alf_mobiliers\alf_barrel\barrel.p3d","alf_mobiliers\alf_security\alf_security.p3d","alf_batiments\alf_cupidon\alf_cupidon_m.p3d",
							...
							"alf_mobiliers\alf_g_chaise\alf_g_chaise_bois.p3d","a3\structures_f_heli\furniture\officechair_01_f.p3d"];		
...
ALF_BIE_SECTEUR_4 = (nearestObjects [(getMarkerPos "bie_secteur_4"),["Land_ALF_Trafo"],5000]) select 0;
publicVariable "ALF_BIE_SECTEUR_4";
