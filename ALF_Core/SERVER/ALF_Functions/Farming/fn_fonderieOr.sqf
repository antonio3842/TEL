...
private _or = {_x isEqualTo "Land_ALF_Pierre_or"} count (magazines _unit);
if (_or isEqualTo 0) exitWith {["Info", "Vous n'avez plus de minerai sur vous !!", "warning", false] remoteExec ["ALF_fnc_doMsg",_unit]};

/////////////////////////// PROCESS ///////////////////////////////////////
_curTarget animate ['door', 1];
["Land_ALF_Pierre_or",false] remoteExec ["ALF_fnc_handleItem",_unit];
...
_obj addMagazineCargoGlobal ["Land_ALF_Pierre_or",1];
...
playSound3D ["ALF_Client2\sounds\four_fer.ogg",_curTarget, false,getpos _curTarget, 1, 1, 100];
uiSleep 101;

private _obj2 = "groundweaponholder" createVehicle [0,0,0];
_obj2 setPosATL (_curTarget modelToWorld [-0.5,0.13,-0.39]);
_obj2 addMagazineCargoGlobal ["ALF_Pepite_Or",1];
