...
private _fer = {_x isEqualTo "ALF_pierre_fer_small"} count (magazines _unit);
if (_fer isEqualTo 0) exitWith {["Info", "Vous n'avez plus de minerai sur vous !!", "warning", false] remoteExec ["ALF_fnc_doMsg",_unit]};

/////////////////////////// PROCESS ///////////////////////////////////////
_curTarget animate ['door', 1];
["ALF_pierre_fer_small",false] remoteExec ["ALF_fnc_handleItem",_unit];
