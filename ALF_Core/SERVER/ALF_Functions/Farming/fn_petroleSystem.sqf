...
if !("ALF_Barile_P_E" in (magazines _unit)) exitWith {["INFO","Vous n'avez pas de baril vide.","warning"] remoteExec ["ALF_fnc_doMsg",_unit];};
...
["ALF_Barile_P_E",false] remoteExec ["ALF_fnc_handleItem",_unit];
...
playSound3D ["ALF_Client2\sounds\wip.ogg",_obj, false, getPos _obj, 1, 1, 100];
