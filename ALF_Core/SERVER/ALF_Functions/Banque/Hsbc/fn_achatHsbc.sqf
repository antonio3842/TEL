...
_count = ([format["SELECT COUNT(*) FROM hsbc WHERE numacc='%1'",_nb],2] call ALF_Server_fnc_asyncCall) select 0;

if (_count > 0) exitWith { [_uid,_unit] call ALF_Server_fnc_achatHsbc; };
