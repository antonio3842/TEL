...
private _i = selectRandom["ALF_pierre_small","ALF_Cuivre","ALF_Fer","ALF_diamant_taille","ALF_Mais","ALF_Buche","ALF_Weed","Verre_plat","ALF_Planche_B","ALF_diamant_precieux"];
...
private _msg = switch (_i) do {
	...
	case "Verre_plat" : {format["Les actions concernant le Verre viennent d'exploser, passant de %1€ à %2€ !!!",floor(_old),floor(_curItemPrice)]};
