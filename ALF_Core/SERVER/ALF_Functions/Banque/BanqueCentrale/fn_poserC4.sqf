...
[_banque] spawn {
	...
	for "_i" from 0 to 1 step 0 do {
		...
		_time = _time + 1;
		playSound3D ["ALF_Client2\sounds\banque_alarm.ogg", _banque, false, getPos _banque, 3, 1, 150];
		uiSleep 50;
	};
};
...
[_banque] spawn {
	_banque = _this select 0;
	_comico = nearestObjects [_banque, ["Land_mrp_gendarmerie_principale","Land_mrp_gendarmerie_e","Land_MRP_gendarmerie2","Land_MRP_Caserne_GN"], 15000];
	_timer = 0;
	for "_i" from 0 to 1 step 0 do {
