...
[format["UPDATE CNP SET bank='%1' WHERE id='1'",_value],1] call ALF_Server_fnc_asyncCall;

[format["INSERT INTO CNP_LIST (uid, name, value) VALUES ('%1', '%2', '%3')",_uid,_name,_num],1] call ALF_Server_fnc_asyncCall;
