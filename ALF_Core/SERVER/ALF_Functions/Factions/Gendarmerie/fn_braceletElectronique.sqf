...
[format["UPDATE players SET bracelet='1', bracelettime='%2' WHERE playerid='%1'",(getPlayerUID _unit),_temps],1] call ALF_Server_fnc_asyncCall;
...
[[_temps * 60],"ALF_FSM\bracelet.fsm"] remoteExecCall ["execFSM",_unit];
