...
_newvalue = [_newvalue] call ALF_Server_fnc_numberSafe;

[format["UPDATE business SET capital='%1', level='%2' WHERE siret='%3' AND active='1'",_newvalue,_level,_siretstr],1] call ALF_Server_fnc_asyncCall;
