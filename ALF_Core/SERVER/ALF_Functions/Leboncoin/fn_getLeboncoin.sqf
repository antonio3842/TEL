...
_r = [format["SELECT id, classname, insure, active, type FROM vehicles WHERE pid='%1' AND alive='1' AND active='0' AND lockveh='0'",_uid],2,true] call ALF_Server_fnc_asyncCall;
