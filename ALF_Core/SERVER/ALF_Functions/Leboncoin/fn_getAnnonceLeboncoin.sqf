...
private _r = ["SELECT id, seller, numid, obj, titre, description, prix, nom, numero, DATE_FORMAT(insert_time,'%d/%m/%Y %HH%i') FROM leboncoin WHERE active='1'",2,true] call ALF_Server_fnc_asyncCall;
