...
private _queryresult = [format["SELECT number FROM phone WHERE number='%1'",_numberCible],2] call ALF_Server_fnc_asyncCall;
if((count _queryresult) isEqualTo 0) exitWith {};

private _msgbin = toArray _msg;
[format["INSERT INTO sms (anonyme, expediteur, destinataire, message) VALUES('%1','%2','%3','%4')",_anonyme,_numberExpediteur,_numberCible,_msgbin],1] call ALF_Server_fnc_asyncCall;
