...
[format["UPDATE fpr SET active='0' WHERE motif='%1' AND active='1'",_msg],1] call ALF_Server_fnc_asyncCall;

uiSleep 1;

private _queryResult = ["SELECT name, motif FROM fpr WHERE active='1'",2,true] call ALF_Server_fnc_asyncCall;
