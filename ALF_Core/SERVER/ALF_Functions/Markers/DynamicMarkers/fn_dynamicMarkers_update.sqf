...
private _new = [_marker] call ALF_Server_fnc_dynamicMarkers_getPos;
...
[format["UPDATE dynamic_markers SET pos='%1' WHERE name='%2'", _new, _marker], 1] call ALF_Server_fnc_asyncCall;
