...
player setVariable ["ALF_ownerID", clientOwner, true];
...
/* setup license */
private _licenceC = ["CLASSES", ["Licenses"]] call ALFTools_Client_Config_fnc_getConfig;
{
    _varname = ["STRING", ["variable"], _y] call ALFTools_Client_Config_fnc_getConfig;
    private _varNameConfig = ["STRING", ["Licenses", _varName, "variable"]] call ALFTools_Client_Config_fnc_getConfig;
    private _varNameC = format["license_%1", _varNameConfig];
    SVAR_MNS [_varNameC, false];
} forEach _licenceC;