...
[{
	...
	if((time - ALF_Survival_drunkTime) > 360) then {if (life_drunk > 0) then {if (life_drunk isEqualTo 0) then {hint "Vous n'avez plus d'alcool dans le sang.";};}; ALF_Survival_drunkTime = time;};
