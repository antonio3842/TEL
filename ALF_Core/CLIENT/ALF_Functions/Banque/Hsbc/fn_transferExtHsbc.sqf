...
if (life_hsbc < _number) exitWith {["HSBC", "Vous n'avez pas assez de fond sur votre compte en Suisse.", "danger", false] spawn ALF_fnc_doMsg;};
[_numacc,player,_number,getPlayerUID player] remoteExecCall ["ALF_Server_fnc_transferExtHsbc",2];
