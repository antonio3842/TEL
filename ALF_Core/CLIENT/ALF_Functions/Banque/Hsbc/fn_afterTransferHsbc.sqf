...
["HSBC", format["Vous avez transféré %1/CHF de votre compte en Suisse sur le compte numéro %2.",[_number] call ALF_fnc_numberText,_numacc], "success", false] spawn ALF_fnc_doMsg;
