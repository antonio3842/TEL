...
if !(_bad) then {
	...
	_texteconversiontoeuro ctrlSetStructuredText parseText format["<t align='center' color='#000000' size='1.4px'>%1€</t>",[_numbertoeuro] call ALF_fnc_numberText];
	_texteconversiontochf ctrlSetStructuredText parseText format["<t align='center' color='#000000' size='1.4px'>%1/CHF</t>",[_numbertochf] call ALF_fnc_numberText];
