...
if (life_hsbc < _number) exitWith {["HSBC", "Vous n'avez pas cet argent sur votre compte en Suisse.", "danger", false] spawn ALF_fnc_doMsg;};
life_hsbc = life_hsbc - _number;
life_cash = life_cash + _number;
["HSBC", format["Vous avez retiré %1€ votre compte en Suisse.",_number], "success", false] spawn ALF_fnc_doMsg;
