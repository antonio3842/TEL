...
switch (_mode) do {
	case 0 : {
		if(life_livreta >= 0) then {
			_textelivret ctrlSetStructuredText parseText format["<t align='center' color='#000000' size='1.4px'>%1€</t>",[life_livreta] call ALF_fnc_numberText];
		} else {
			_textelivret ctrlSetStructuredText parseText format["<t align='center' color='#FF0000' size='1.4px'>%1€</t>",[life_livreta] call ALF_fnc_numberText];
		};
	...
	case 1 : {
		_textelivret ctrlSetStructuredText parseText format["<t align='center' color='#000000' size='1.4px'>%1€</t>",[life_livretb] call ALF_fnc_numberText];
		_textecash ctrlSetStructuredText parseText format["<t align='center' color='#000000' size='1.4px'>%1€</t>",[life_cash] call ALF_fnc_numberText];
	};

	case 2 : {
		_textelivret ctrlSetStructuredText parseText format["<t align='center' color='#000000' size='1.4px'>%1€</t>",[life_livretc] call ALF_fnc_numberText];
		_textecash ctrlSetStructuredText parseText format["<t align='center' color='#000000' size='1.4px'>%1€</t>",[life_cash] call ALF_fnc_numberText];
	};
};
