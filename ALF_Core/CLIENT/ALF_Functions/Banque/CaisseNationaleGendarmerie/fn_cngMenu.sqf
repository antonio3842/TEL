// ALF_fnc_cngMenu = {
if(life_copLevel < 6) exitWith {["INFO","Vous n'avez pas le grade.","warning"] spawn ALF_fnc_doMsg;};
disableSerialization;
if(isnull findDisplay 16500) then {createDialog "ALF_CNG";};
disableSerialization;
...
switch (_menu) do 
{
	...
	case 1 : 
	{
		...
		[player] remoteExec ["ALF_Server_fnc_listCNG",2];
	};
};
// };