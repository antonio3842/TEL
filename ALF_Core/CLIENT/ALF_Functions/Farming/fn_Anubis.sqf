...
switch (_mode) do {
	case 1 : {["ALF_Relique_1",false] spawn ALF_fnc_handleItem;};
	case 2 : {["ALF_Relique_2",false] spawn ALF_fnc_handleItem;};
	case 3 : {["ALF_Relique_3",false] spawn ALF_fnc_handleItem;};
};
...

{
	...
	sleep 1.5;
	playSound3D ["ALF_Client2\sounds\boum.ogg",_x,false,getPos _x,1,1,100];
} forEach _a1;
