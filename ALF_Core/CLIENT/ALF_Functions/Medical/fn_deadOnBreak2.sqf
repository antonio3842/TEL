...
for "_i" from 0 to 1 step 0 do {
	...
	if(alf_ms_bpm isEqualTo 0 || {alf_ms_bpm isEqualTo 200}) exitWith {player setDamage 0.7;};
	if(alf_ms_mmHg < 20 || {alf_ms_mmHg > 180}) exitWith {player setDamage 0.7;};
	if(alf_ms_spo2 < 50) exitWith {player setDamage 0.7;};
	if(alf_ms_resp < 7) exitWith {player setDamage 0.7;};
	if(alf_ms_pain isEqualTo 100) exitWith {player setDamage 0.7;};
