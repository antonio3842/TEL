...
_btn1 ctrlSetText "METTRE SUR LE BRANCARD";
_btn1 buttonSetAction "[life_pInact_curObject,[""ALF_Brancard_P"",""VEH_MRP_Brancard_Vsav""]] call ALF_fnc_putInCarsp; closeDialog 0;";

_btn8 ctrlSetText "METTRE DANS LE FAUTEUIL";
_btn8 buttonSetAction "[life_pInact_curObject,""ALF_Wheelchair_P""] call ALF_fnc_putInCarsp; closeDialog 0;";

_btn2 ctrlSetText "APPLIQUER LE BANDAGE";
...
for "_i" from 0 to 1 step 0 do {
	...
	if(count (nearestObjects[position player,["ALF_Brancard_P","VEH_MRP_Brancard_Vsav"],5]) > 0 && {isNull objectParent life_pInact_curObject}) then {
