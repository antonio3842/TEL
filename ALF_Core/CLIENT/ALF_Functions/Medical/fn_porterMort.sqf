...
switch (_mode) do {
	...
	case 0: {
		...
		if (_target getVariable ["requestMedic",false]) then {
			["INFO", "Faites attention à vos mouvements. Ne déplacez pas la victime à plus de 100 mètres.", "warning"] spawn ALF_fnc_doMsg;
		};
