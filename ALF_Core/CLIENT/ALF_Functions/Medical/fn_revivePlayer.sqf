...
for "_i" from 0 to 1 step 0 do {
	if(animationState player != "AinvPknlMstpSnonWnonDnon_medic_1") then {
		[player,"AinvPknlMstpSnonWnonDnon_medic_1"] remoteExecCall ["ALF_fnc_animSync",RCLIENT];
...
[player] remoteExec ["ALF_fnc_revived",_target];

[_targetName,_uid,"MORT",format ["A été réanimé par %1",profileName]] remoteExec ["ALF_Server_fnc_logIt",2];
...
[500] remoteExecCall ["ALF_Server_fnc_updateCNP",2];
