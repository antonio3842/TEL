...
private _action = ["Etes-vous certain de vouloir agrandir votre entreprise pour une valeur de 500.000€.","Entreprise","OUI","NON"] call BIS_fnc_guiMessage;
...
[_siretstr,_newvalue,1] remoteExec ["ALF_Server_fnc_agrandirBusiness",2];
