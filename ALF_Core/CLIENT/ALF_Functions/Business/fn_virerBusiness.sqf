...
if(_uidmember isEqualTo _myUid) exitWith {["INFO","Vous ne pouvez pas vous virer vous même.","warning"] spawn ALF_fnc_doMsg;};
...
private _action = [format["Etes-vous certain de vouloir virer %1 de votre entreprise ?",_namemember],"Entreprise","OUI","NON"] call BIS_fnc_guiMessage;
