...
life_garage_sp = [(_building modelToWorldVisualWorld [-8,-14,0.5]),getDir _building,_building];
...
[_building,_siretstr,_owner,player] remoteExec ["ALF_Server_fnc_getVehiclesBusiness",2];
