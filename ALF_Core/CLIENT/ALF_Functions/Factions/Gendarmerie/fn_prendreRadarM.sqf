...
if !(player canAdd "ALF_Rangefinder") exitWith {["Radar Mobile", "Vous n'avez pas la place.", "warning"] spawn ALF_fnc_doMsg;};
_radar animate ["clic",1];
_radar setVariable ["RadarM",[0,0,[]],true];
["ALF_Rangefinder",true] spawn ALF_fnc_handleItem;
