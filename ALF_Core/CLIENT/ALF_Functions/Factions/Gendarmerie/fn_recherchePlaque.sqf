...
_allowed1 = toArray("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ");
_allowed2 = toArray("0123456789");

if(_length1 > 1) exitWith {hint "Vous ne pouvez ecrire que 1 caractère."};
if(_length2 > 1) exitWith {hint "Vous ne pouvez ecrire que 1 caractère."};
if(_length3 > 1) exitWith {hint "Vous ne pouvez ecrire que 1 caractère."};
if(_length4 > 1) exitWith {hint "Vous ne pouvez ecrire que 1 caractère."};
if(_length5 > 1) exitWith {hint "Vous ne pouvez ecrire que 1 caractère."};
if(_length6 > 1) exitWith {hint "Vous ne pouvez ecrire que 1 caractère."};
if(_length7 > 1) exitWith {hint "Vous ne pouvez ecrire que 1 caractère."};
...
[_plaque,player] remoteExec ["ALF_Server_fnc_recherchePlaque",2];
