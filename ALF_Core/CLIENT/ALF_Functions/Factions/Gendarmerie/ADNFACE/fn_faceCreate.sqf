...
if (_length2 > 300) exitWith {["INFO","Vous ne pouvez ecrire que 300 caractères max.","warning"] spawn ALF_fnc_doMsg;};
...
private _action = ["Etes-vous sûr de vouloir creer ce dossier, s'il existe dejà, le motif sera ecrase et mit à jour.","Faciès","OUI","NON"] call BIS_fnc_guiMessage;
if (!_action) exitWith {};

[_codeadn,_motif,player] remoteExec ["ALF_Server_fnc_faceCreate",2];
closeDialog 0;
