...
_spikeStrip = "land_O2_Stop_Stick_x2" createVehicle [0,0,0];
_spikeStrip setDir 90;
_spikeStrip attachTo[player,[0,4,0.2]];
_spikestrip setVectorDirAndUp [[1,0,0],[0,0,1]];
[_spikeStrip,true] remoteExecCall ["enableDynamicSimulation",2];
...
[_spikeStrip] remoteExec ["ALF_Server_fnc_spikeStrip",2]; //Send it to the HeadlessClient for monitoring.
