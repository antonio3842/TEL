...
switch (_mode) do {
	...
	case 1: {
		...
		lbClear 754722;
		[_histtexte] remoteExecCall ["ALF_Server_fnc_getMSGFromNumber",2];
	};
	...
	case 3: {
		...
		if((_msg select 0) isEqualTo "Aucun historique.") then {
			_txtControl ctrlSetStructuredText parseText format["<t shadow='0' color='#FFFFFF' font='HelveticaLTLight' size='1'>Aucun message.</t>"];
		} else {
