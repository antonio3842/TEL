...
if(_data isEqualTo "Aucune donnée") then {
	_text ctrlSetStructuredText parseText  format["<t shadow='0' color='#000000' font='HelveticaLTLight' size='1'>La liste est vide.</t>"];
} else {
	...
	_text ctrlSetStructuredText parseText format ["<t shadow='0' color='#000000' font='HelveticaLTLight' size='1'>%1</t>",_struct];
};
