...
if(life_permis isEqualTo 0) then {
	...
	["Radar Mobile",format["Vous venez d'être flashé à %2Km/h pour %1Km/h. Amende de %3€ prélevé de votre compte bancaire.",_speedlimit,_speed,_amende], "warning", false] spawn ALF_fnc_doMsg;
	["Permis",format["Vous avez perdu %1 point(s). Il vous reste 0 point(s) sur votre permis. Il a été retiré.",_pt], "warning", false] spawn ALF_fnc_doMsg;
} else {
	["Radar Mobile",format["Vous venez d'être flashé à %2Km/h pour %1Km/h. Amende de %3€ prélevé de votre compte bancaire.",_speedlimit,_speed,_amende], "warning", false] spawn ALF_fnc_doMsg;
	["Permis",format["Vous avez perdu %1 point(s). Il vous reste %2 point(s) sur votre permis.",_pt,life_permis], "warning", false] spawn ALF_fnc_doMsg;
};
