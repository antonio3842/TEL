...
private _msg2 = format["%1 à été vire des pompiers.",_name];
...
switch (_mode) do {
	...
	case 1 : {
		...
		_msg2 = format["%1 à été promu Sapeur.",_name];
	};
	case 2 : {
		life_medicLevel = 2;
		license_med = true;
		_msg = "Tu es promu Sapeur 1ere Cl.";
		_msg2 = format["%1 à été promu Sapeur 1ere Cl.",_name];
	};
	case 3 : {
		life_medicLevel = 3;
		license_med = true;
		_msg = "Tu es promu Caporal.";
		_msg2 = format["%1 à été promu Caporal.",_name];
	};
	case 4 : {
		life_medicLevel = 4;
		license_med = true;
		_msg = "Tu es promu Caporal chef.";
		_msg2 = format["%1 à été promu Caporal chef.",_name];
	};
	case 5 : {
		life_medicLevel = 5;
		license_med = true;
		_msg = "Tu es promu Sergent.";
		_msg2 = format["%1 à été promu Sergent.",_name];
	};
	case 6 : {
		life_medicLevel = 6;
		license_med = true;
		_msg = "Tu es promu Sergent chef.";
		_msg2 = format["%1 à été promu Sergent chef.",_name];
	};
	case 7 : {
		life_medicLevel = 7;
		license_med = true;
	...
	case 11 : {
		if(license_SAMU) then {
			...
			_msg2 = format["%1 à été promu SAMU.",_name];
		};
	};
	case 12 : {
		life_medicLevel = 12;
		license_med = true;
		_msg = "Tu es promu Lieutenant-Colonel.";
		_msg2 = format["%1 à été promu Lieutenant-Colonel.",_name];
	};
	case 13 : {
		life_medicLevel = 13;
		license_med = true;
		_msg = "Tu es promu Colonel.";
		_msg2 = format["%1 à été promu Colonel.",_name];
	};
};
...
["Pompiers.",format["%1",_msg2]] remoteExecCall ["ALF_Server_fnc_doMedCall",2];
