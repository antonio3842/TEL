...
["Caisse nationale.",format["%1 a déposé %2€ dans la Caisse Nationale des Pompiers.",_name,[_num] call ALF_fnc_numberText]] remoteExecCall ["ALF_Server_fnc_doMedCall",2];

[] remoteExec ["ALF_Server_fnc_deposerCNP",2];