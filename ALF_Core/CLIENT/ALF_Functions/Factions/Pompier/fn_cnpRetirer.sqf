...
["Caisse nationale.",format["%1 a retiré %2€ de la caisse nationale des Pompiers.",_name,[_num] call ALF_fnc_numberText]] remoteExecCall ["ALF_Server_fnc_doMedCall",2];

[_uid,_name,_num] remoteExec ["ALF_Server_fnc_retirerCNP",2];
