...
switch (_mode) do {
	case 0 : {
		...
		private _wheels = ["HitLFWheel","HitLF2Wheel","HitRFWheel","HitRF2Wheel","HitLMWheel","HitLBWheel","HitRMWheel","HitRBWheel","HitFWheel","HitBWheel"];
