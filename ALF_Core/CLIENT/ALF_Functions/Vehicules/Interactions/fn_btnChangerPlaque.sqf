...
private _action = ["Voulez-vous faire changer votre plaque pour une somme de 15.000€. Attention, cette manipulation est illégale.","Action Bricolage","OUI","NON"] call BIS_fnc_guiMessage;
if (!_action) exitWith {};
...
if(_exit) exitWith {["INFO","Vous n'avez pas assez d'argent sur vous.","warning"] spawn ALF_fnc_doMsg;};
...
//[_veh,_pfinal] remoteExecCall ["ALF_Server_fnc_changerPlaque",2];

["INFO","La plaque de votre véhicule vient d'être changer.","success"] spawn ALF_fnc_doMsg;