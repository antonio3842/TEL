...
if(_c > 0) then {
	...
	private _a = [format["Le véhicule est rempli de %1 sachet(s) de cannabis d'une valeur de %2€. Voulez-vous les saisir? Cela enlevera tout ce qu'il y a dans le coffre.",_cf,[_pf] call ALF_fnc_numberText],"VEHICULE","OUI","NON"] call BIS_fnc_guiMessage;
	if !(_a) exitWith {};
