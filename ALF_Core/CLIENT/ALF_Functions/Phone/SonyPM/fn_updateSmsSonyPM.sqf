...
waitUntil {sleep 0.1; !isNull (findDisplay 20520)};
private _playerList = ((findDisplay 20520) displayCtrl 39144);
private _replyButton = ((findDisplay 20520) displayCtrl 39146);
private _delButton = ((findDisplay 20520) displayCtrl 39147);
...
else
{
	...
	_delButton buttonSetAction "[] spawn ALF_fnc_deleteSmsSonyPM;";
};
((findDisplay 20520) displayCtrl 39144) lbSetCurSel 0;
