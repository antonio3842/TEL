...
if(_length < 10) exitWith {hint "Vous ne pouvez pas repondre à ce numéro."};
if(_anonyme isEqualTo 1) exitWith {hint "Vous ne pouvez pas repondre à un numéro anonyme."};
...
_menuNMnum ctrlSetStructuredText parseText format["<t align='left' shadow='0' color='#000000' font='HelveticaLTLight' size='1'>%1</t>",_name];
