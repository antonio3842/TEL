...
switch (_menu) do {
	case 0 : {
		_dateiphone ctrlSetStructuredText parseText format["<t align='right' shadow='0' color='#ffffff' font='HelveticaLTLight' size='.5'>%1:%2</t>", _hour,_min];
	};
	default {
		_dateiphone ctrlSetStructuredText parseText format["<t align='right' shadow='0' color='#000000' font='HelveticaLTLight' size='.5'>%1:%2</t>", _hour,_min];
	};
};
