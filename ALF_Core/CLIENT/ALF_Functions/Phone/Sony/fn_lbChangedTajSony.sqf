...
if(_data isEqualTo "Casier vierge.") then {
	_text ctrlSetStructuredText parseText  format["<t shadow='0' color='#000000' font='HelveticaLTLight' size='2'>Casier vierge.</t>"];
} else {
	...
	_text ctrlSetStructuredText parseText format ["<t shadow='0' color='#000000' font='HelveticaLTLight' size='1'>%1</t><br/><br/><t shadow='0' color='#000000' font='HelveticaLTLight' size='0.85'>%2</t>",_lieu,_infra];
