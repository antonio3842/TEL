...
if(_length2 > 40) exitWith {hint "Vous ne pouvez écrire que 40 caractères max."};
if(_length3 > 20) exitWith {hint "Vous ne pouvez écrire que 20 caractères max."};
if(_length5 > 300) exitWith {hint "Vous ne pouvez écrire que 300 caractères max."};
...
[_fipName,_mode,_lieu,_date,_infraction,player] remoteExecCall ["ALF_Server_fnc_createTajSony",2];
