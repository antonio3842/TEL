...
if(_type isEqualTo 1 && _freq isEqualTo 0) exitWith {hint "Vous n'avez pas ce mode d'activé.";};
if(_type isEqualTo 2 && _freq2 isEqualTo 0) exitWith {hint "Vous n'avez pas ce mode d'activé.";};
