...
if !(license_gun) exitWith {["INFO", "Vous n'avez pas la licence. Rapprochez‑vous auprès du stand de tir.", "warning"] spawn ALF_fnc_doMsg;};
...
["INFO", format["Vous avez acheté pour %1€ sur Intranet. Tu recevras ça chez vous dans peu de temps.",_pricett], "success"] spawn ALF_fnc_doMsg;
[name player,getPlayerUID player,"INTERNET",format["A acheté %1€ sur internet (Armurerie).",_pricett]] remoteExec ["ALF_Server_fnc_logIt",2];
