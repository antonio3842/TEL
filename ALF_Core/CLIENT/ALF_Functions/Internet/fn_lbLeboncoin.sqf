...
_txt1 ctrlSetStructuredText parseText format["<t shadow='0' color='#000000' font='HelveticaLTLight' size='1'>%1</t>",_data select 2];

_txt2 = (findDisplay 24500) displayCtrl 24534;
_txt2 ctrlSetStructuredText parseText format["<t shadow='0' color='#000000' font='HelveticaLTLight' size='0.8'>%2</t><br/><t shadow='0' color='#000000' font='HelveticaLTLight' size='1'>%1</t>",_data select 5,_data select 9];

_txt3 = (findDisplay 24500) displayCtrl 24535;
_txt3 ctrlSetStructuredText parseText format["<t shadow='0' color='#000000' size='1'>%1€</t>",[_data select 6] call ALF_fnc_numberText];

_txt4 = (findDisplay 24500) displayCtrl 24536;
_txt4 ctrlSetStructuredText parseText format["<t shadow='0' color='#000000' font='HelveticaLTLight' size='1'>%1</t>",_data select 7];

_txt5 = (findDisplay 24500) displayCtrl 24537;
if((_data select 8) isEqualTo "0") then {
	_txt5 ctrlSetStructuredText parseText format["<t shadow='0' color='#000000' font='HelveticaLTLight' size='1'>%1</t>","**********"];
} else {
	_txt5 ctrlSetStructuredText parseText format["<t shadow='0' color='#000000' font='HelveticaLTLight' size='1'>%1</t>",_data select 8];
};
...
if((_data select 1) isEqualTo (getPlayerUID player)) then {
	...
	_btn3lbc ctrlShow true;
	_btn3lbc buttonSetAction "[] spawn ALF_fnc_achatLeboncoin;";
};
if(life_copLevel > 3 OR {ALF_AdminLevel > 0}) then {
