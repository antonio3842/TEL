...
if(_badChar) exitWith {["INFO", "La quantité est incorrecte.", "warning"] spawn ALF_fnc_doMsg;};
_number = parseNumber(_number);
if(_number < 1) exitWith {["INFO", "La quantité est incorrcte.", "warning"] spawn ALF_fnc_doMsg;};
