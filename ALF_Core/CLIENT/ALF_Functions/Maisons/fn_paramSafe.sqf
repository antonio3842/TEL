...
if(_mode isEqualTo 0) then {
	...
	_btn buttonSetAction "[life_pInact_mobilier,2] call ALF_fnc_paramSafe;";
};

if(_mode isEqualTo 1) then {
	_btn ctrlSetText "PARAMETRER";
	_btn buttonSetAction "[life_pInact_mobilier,3] call ALF_fnc_paramSafe;";
};
...
if(_mode isEqualTo 3) then {
	...
	closeDialog 158532;
	[_container,_num] remoteExecCall ["ALF_Server_fnc_editSafeCode",2];
	closeDialog 37400;
};
