...
if !(_inUse isEqualTo "") exitWith {["INFO","Quelqu'un regarde deja dedans.","warning"] spawn ALF_fnc_doMsg;};
...
["INFO","Attention : videz vos sacs / vetements avant de les ranger.","warning"] spawn ALF_fnc_doMsg;
...
_btnput buttonSetAction "[life_pInact_curObject] call ALF_fnc_putInMobilier;";

_btnTake ctrlEnable true;
_btnTake buttonSetAction "[life_pInact_curObject] call ALF_fnc_takeInMobilier;";
