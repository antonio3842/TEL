...
if(_mode) then {
	...
	switch(true) do {
		case ((typeOf _house) in ["Land_House_Small_02_F","Land_House_Small_01_F","Land_House_Small_03_F","Land_House_Small_06_F","Land_House_Small_04_F","Land_House_Small_05_F","Land_i_House_Small_01_b_brown_F","Land_ALF_Caravane","Land_i_Garage_V1_F","Land_i_Garage_V2_F","Land_Garage","Land_Garage2","Land_HouseA","Land_HouseB","Land_HouseC","Land_HouseD","Land_Hotel_02_F","Land_i_Stone_HouseSmall_V2_F","Land_i_Stone_HouseSmall_V1_F","Land_i_Stone_HouseSmall_V3_F"]): {_lightSource lightAttachObject [_house,[0,0,2.4]];};
		...
		case ((typeOf _house) in ["Land_ALF_MaisonMetal","Land_ALF_MaisonMetal_Blanc","Land_ALF_MaisonMetal_Verte","Land_ALF_MaisonMetal_Rouge","Land_ALF_MaisonMetal_Grise","Land_ALF_MaisonMitoyenne","Land_ALF_MaisonMitoyenne1","Land_Residence_A_1","Land_Residence_A_2","Land_Residence_A_3"]): {_lightSource lightAttachObject [_house,[-3.3,1,2.5]];};
		case ((typeOf _house) in ["Land_ALF_MaisonModerne","Land_ALF_MaisonModerne_Blanc","Land_ALF_MaisonModerne_Verte","Land_ALF_MaisonModerne_Rouge","Land_ALF_MaisonModerne_Grise","Land_ALF_MaisonContemporaine","ALF_MaisonParadise"]): {_lightSource lightAttachObject [_house,[-3.3,1,2.5]];};
		default {_exit = true;};
	};
