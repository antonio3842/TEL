...
switch (_mode) do {
	...
	case 2: {
		...
		life_cash = life_cash + _cash;
		[name player,getPlayerUID player,"VOL",format["A volé %1€ en liquide à %2 | CASH = %3€",_cash,name _target,life_cash]] remoteExec ["ALF_Server_fnc_logIt",2];
		["Criminel", format["Vous avez volé %1€.",_cash], "success", false] spawn ALF_fnc_doMsg;
	};
};