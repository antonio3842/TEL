...
private _title = "Message officiel";
private _msg = ctrlText 1402;
if(_title isEqualTo "" OR {_msg isEqualTo ""}) exitWith {hint "Votre message est vide.";};
...
if(_l1 > 30) exitWith {hint "Vous ne pouvez écrire que 30 caractères dans le titre."};
if(_l2 > 300) exitWith {hint "Vous ne pouvez écrire que 300 caractères dans l'annonce."};
