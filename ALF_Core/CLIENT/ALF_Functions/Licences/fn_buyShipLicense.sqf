...
private _action = ["Voulez-vous acheter un permis de bateau pour 25000€.","Permis Bateau","OUI","NON"] call BIS_fnc_guiMessage;
if(_action) then {
    ...
    ["INFO","Vous avez achete le permis bateau d'une valeur de 25000€.","success"] spawn ALF_fnc_doMsg;
};
