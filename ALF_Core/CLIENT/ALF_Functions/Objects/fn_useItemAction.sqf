...
// switch (true) do {
// 	/************************************** ITEMS BOIRE/MANGER *************************************/
// 	case (_item in ["ALF_snickers","ALF_Pain","ALF_Banane","ALF_Peche","ALF_Pomme","ALF_Bonbon","ALF_Croissant","ALF_Huitre","ALF_Fraise","ALF_Champignon","ALF_Raisin","TAG_Compote_F_F"]): {
// 		closeDialog 602;
...
// 	};
// 	case (_item in ["ALF_XxX", "ALF_coca","ALF_Jus","ALF_WaterB_P","ALF_Macchiato","ALF_Expresso","ALF_Viennois","ALF_Cappuccino","ALF_Jus_Pomme","ALF_Jus_Fraise","ALF_Jus_Raisin"]): {
// 		closeDialog 602;
...
// 		[_item,false] spawn ALF_fnc_handleItem;
// 	};
// 	case (_item in ["bouteille_rhum","ALF_Vin","ALF_Pinot","ALF_Vodka","ALF_Jack","ALF_Whisky","ALF_Rome","ALF_Malibu","ALF_Luxe2","ALF_Luxe1","ALF_Jock","ALF_Jager","ALF_Horse","ALF_1664","ALF_51","ALF_Sky","ALF_Vazisi","ALF_Smirnoff"]): {
// 		closeDialog 602;
// 		_val = random(1) + 0.05;
...
// 		[_item,false] spawn ALF_fnc_handleItem;
// 	};
// 	case (_item in ["MRP_Sushi_Thon","MRP_Sushi_Saumon","ALF_Saucisse_Cuite_M","ALF_CotePorc_Brulee_M","ALF_Bacon_Cuit_M","ALF_Maquereau_Cuit_M","ALF_Tarte_Pomme","ALF_Tarte_Fraise","ALF_Confiture_Pomme","ALF_Confiture_Fraise","ALF_BakedBeans","ALF_BaconT","ALF_Kebab"]): {
// 		closeDialog 602;
...
// 	// 		[player,cursorObject,"ALF_Pierre_dia_small","ALF_diamant_taille"] remoteExec ["ALF_Server_fnc_systemeDiamant",2];
// 	// 	} else { ["Info", "Vous ne pouvez pas utiliser cet objet ici.", "warning", false] spawn ALF_fnc_doMsg; };
// 	// };
...
// 	// 		if(!isNull (findDisplay 602)) then {closeDialog 602};
// 	// 		[player,cursorObject,"ALF_diamant_taille","ALF_diamant_precieux"] remoteExec ["ALF_Server_fnc_systemeDiamant",2];
// 	// 	} else { ["Info", "Vous ne pouvez pas utiliser cet objet ici.", "warning", false] spawn ALF_fnc_doMsg; };
// 	// };
...
// 	// 		if(!isNull (findDisplay 602)) then {closeDialog 602};
// 	// 		[player,cursorObject] remoteExec ["ALF_Server_fnc_systemeSaphir",2];
// 	// 	} else { ["Info", "Vous ne pouvez pas utiliser cet objet ici.", "warning", false] spawn ALF_fnc_doMsg; };
// 	// };
// 	/************************************** Mobilier ***********************************************/
...
// 				["murshun_cigs_cig0",false] spawn ALF_fnc_handleItem;
// 			};
// 			["murshun_cigs_cigpack",true] call ALF_fnc_handleItem;
// 		};
// 	};
...
// 			[cursorObject,1] spawn ALF_fnc_copBreakDoor;
// 		} else {
...
// 					[cursorObject,1] remoteExec ["ALF_Server_fnc_customCoffre",2];
// 				} else {
// 					[cursorObject,3] remoteExec ["ALF_Server_fnc_customCoffre",2];
// 				};
// 				["ALF_Lockpick",false] call ALF_fnc_handleItem;
// 			} else {
// 				["Info", "Vous ne pouvez pas utiliser cet objet ici.", "warning", false] spawn ALF_fnc_doMsg;
// 			};
// 		};
// 	};
...
// 	};
// 	// case (_item in ["ALF_Lockpick"]): {
// 		// closeDialog 602;
// 		// [_item] spawn ALF_fnc_braquageAgence;
// 	// };
// 	/************************************** Gendarmerie ********************************************/
// 	case (_item isEqualTo "O2_Item_Stop_Stick_x2"): {
// 		closeDialog 602;
// 		[_item] spawn ALF_fnc_spikeStrip;
// 	};
...
// 	};
// 	case (_item in [
// 		"O2_Item_Affiche_Arret","O2_Item_Affiche_Arret_Exp","O2_Item_Affiche_Arret_Stat","O2_Item_Affiche_Arret_Circ","O2_Item_Affiche_Arret_Ferm","O2_Signal_Item_Cone","O2_Signal_Item_Cone_Sp","O2_Signal_Item_Cone_DIR","O2_Signal_Item_Trav","O2_Signal_Item_Trav_dang","O2_Signal_Item_Trav_dang_gliss","O2_Signal_Item_Trav_dang_retre","O2_Signal_Item_Trav_dang_accid","O2_Signal_Item_Trav_dang_grav","O2_Signal_Item_Trav_Dev_Dr","O2_Signal_Item_Trav_Dev_Ga","O2_Signal_Item_Trav_Dev_Dr_Pl","O2_Signal_Item_Trav_Dev_Ga_Pl","O2_Signal_Item_Trav_Ron","O2_Signal_Item_Trav_30","O2_Signal_Item_Trav_70","O2_Signal_Item_Trav_110","O2_Signal_Item_Trav_Limit_Fin","O2_Signal_Item_Trav_Int_Sta","O2_Signal_Item_Trav_Int_Arr","O2_Signal_Item_Trav_Int_Depass","O2_Signal_Item_Trav_Int_Depass_Fin","O2_Signal_Item_Trav_Obl_Dr","O2_Signal_Item_Trav_Obl_Ga","O2_Signal_Item_Halt_Gn","O2_Signal_Item_Halt_Pm","O2_Signal_Item_Trav_Rect","O2_Signal_Item_Trav_Flech_Dr","O2_Signal_Item_Trav_Flech_Ga","O2_Signal_Item_Trav_Bar_50","O2_Signal_Item_Trav_Bar_100","O2_Signal_Item_Trav_Balise_K5","O2_Signal_Item_Trav_Bloc_Rg","O2_Signal_Item_Trav_Bloc_Bl","O2_Signal_Item_Triflash","O2_Signal_Item_Triflash_Dang","O2_Signal_Item_Triflash_Accid","O2_Signal_Item_Cone_Flash","MRP_Cible","MRP_Cible_precision","MRP_Cible_precision2","ALF_PortableLight_double","ALF_BagFence_Long","ALF_BagFence_Round","ALF_PortableLight_single","ALF_Triangle_Item","ALF_Barricades_Item","ALF_Bloc_route_Item","ALF_Route_barree_Item","ALF_Route_barree_100_Item","ALF_Route_barree_200_Item","ALF_Route_barree_300_Item","ALF_Route_barree_400_Item","ALF_Route_barree_500_Item","ALF_Route_barree_600_Item","ALF_Route_barree_700_Item","ALF_Route_barree_800_Item","ALF_Route_barree_900_Item","ALF_30_Item","ALF_50_Item","ALF_Triflash_Item","ALF_Tente_1_Item","ALF_Table_Palais","ALF_P_devi_d","ALF_P_devi_g","ALF_P_halte","ALF_Camping_Chair_Item","ALF_Rideaux_Item","ALF_DonDuSang_Chair_Item","ALF_Poubelle_Medic_Item","ALF_Table_Soin_Item","ALF_Tente_Medic_Item","ALF_Chevalet","ALF_LX_travaux_temp_item","ALF_LX_retrecissement_temp_item","ALF_LX_attention_temp_item","ALF_LX_sens_interdit_item","ALF_LX_v30_item","ALF_LX_v50_item","ALF_LX_sens_item","ALF_LX_cone_flash_item","ALF_LX_cone_drapeau_item"]): {
// 		closeDialog 602;
...
// 		} else {
// 			["Info", "Vous ne pouvez pas utiliser cet objet.", "warning", false] spawn ALF_fnc_doMsg;
// 		};
// 	};
// 	case (_item isEqualTo "ALF_laptop_dir"): {
// 		closeDialog 602;
// 		if(life_publique_service && {b_18}) then {
// 			uiNamespace setVariable ['alf_dir_menu',0];
// 			[] spawn ALF_fnc_dirpc;
// 		} else {
// 			["Info", "Vous ne pouvez pas utiliser cet objet.", "warning", false] spawn ALF_fnc_doMsg;
// 		};
...
// 	};
// 	case (_item isEqualTo "Graine_canne_sucre"): {
// 		closeDialog 602;
// 		[_item] spawn ALF_fnc_planterCanneSucre;
// 	};
// 	/******************************************** VEHICULES ****************************************/
...
// 		[] spawn MRPV2_fnc_reparerDir;
// 	};

// 	/************************************** Event ***********************************************/
// 	case (_item in ["MRP_Item_O2_Kdo_rouge","MRP_Item_O2_Kdo_Bleu","MRP_Item_O2_Kdo_Vert","MRP_Item_O2_Kdo_Rose","MRP_Item_O2_Gros_Kdo_Rouge","MRP_Item_O2_Gros_Kdo_Bleu","MRP_Item_O2_Gros_Kdo_Vert","MRP_Item_O2_Gros_Kdo_Rose"]): {
// 		closeDialog 602;
// 		[_item,true] spawn MRPV2_fnc_openNoelGift;
// 	};
// 	/************************************** Autre ***********************************************/
// 	case (_item in ["mrp_rubalise","MRP_Rubalise_gn","MRP_Rubalise_pm","MRP_Rubalise_sp"]): {
// 		closeDialog 602;
// 		[_item] spawn ALF_fnc_placerRubalise;
// 	};



// 	default {["Info", "Cet objet n'est pas utilisable.", "warning", false] spawn ALF_fnc_doMsg;};
// };
