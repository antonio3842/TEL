/* 
Ouverture du menu custom piano 
*/
...
0 = ["DynamicBlur", 400, [7]] spawn
  {
    ...
    switch (player getVariable "ColorMenuActivated") do {
      case 0: {
        ...
        ((uiNamespace getVariable "pianomenu")displayCtrl 0006) ctrlSetStructuredText parseText format["<t align='center'><t font='PuristaLight' color='#FFF' size='1' shadow='0'><img shadow='0' size='1' image='\ALF_Client2\piano\images\KeyCtrl.paa'></img> + <img shadow='0' size='1' image='\ALF_Client2\piano\images\KeyC.paa'></img> TERMINÉ</t>"];
