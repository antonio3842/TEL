/* 
Menu de custom des couleurs du piano
*/
...
((uiNamespace getVariable "pianomenu")displayCtrl 0006) ctrlSetStructuredText parseText format["<t align='center'><t font='PuristaLight' color='#FFF' size='1' shadow='0'><img shadow='0' size='1' image='\ALF_Client2\piano\images\KeyCtrl.paa'></img> + <img shadow='0' size='1' image='\ALF_Client2\piano\images\KeyC.paa'></img> REVENIR EN ARRIÈRE</t>"];
