...
Color Selection System when the player hovers the mouse over a color. (ATTENTION, SOME PROBLEMS WITH SOME, EASILY ADJUSTABLE).

*/

switch (player getVariable "MouseOverButtonColorMenu") do {
  case 1: {
    ((uiNamespace getVariable "pianomenu")displayCtrl 0521) ctrlShow true;
    ((uiNamespace getVariable "pianomenu")displayCtrl 0521) ctrlSetFade 0;
    ((uiNamespace getVariable "pianomenu")displayCtrl 0521) ctrlCommit 0;
    ((uiNamespace getVariable "pianomenu")displayCtrl 0531) ctrlShow false;
    ((uiNamespace getVariable "pianomenu")displayCtrl 0531) ctrlSetFade 1;
    ((uiNamespace getVariable "pianomenu")displayCtrl 0531) ctrlCommit 0;
  ...
  case 2: {
    ((uiNamespace getVariable "pianomenu")displayCtrl 0521) ctrlShow false;
    ((uiNamespace getVariable "pianomenu")displayCtrl 0521) ctrlSetFade 1;
    ((uiNamespace getVariable "pianomenu")displayCtrl 0521) ctrlCommit 0;
    ((uiNamespace getVariable "pianomenu")displayCtrl 0531) ctrlShow true;
    ((uiNamespace getVariable "pianomenu")displayCtrl 0531) ctrlSetFade 0;
    ((uiNamespace getVariable "pianomenu")displayCtrl 0531) ctrlCommit 0;
    ((uiNamespace getVariable "pianomenu")displayCtrl 0529) ctrlShow false;
    ((uiNamespace getVariable "pianomenu")displayCtrl 0529) ctrlSetFade 1;
    ((uiNamespace getVariable "pianomenu")displayCtrl 0529) ctrlCommit 0;
