...
private _y = 0.005;
if ("MRP_Item_Neogend" in str (assignedItems player)) then {_y = -0.05;};
...
_ctrl_Image ctrlSetText "MRP_Telephones\Data\Menu_Principal\Icone_Fond_Etat_dxt5.paa";
...
{
	_ctrl_Image ctrlSetText "MRP_Telephones\Data\Menu_Principal\Icone_Mode_Avion.paa";
} else
{
	_ctrl_Image ctrlSetText "MRP_Telephones\Data\Menu_Principal\Icone_Reseau_dxt5.paa";
};
...
private _ctrl_Image = _Telephone_Base ctrlCreate ["RscPicture",-1,_ctrl_Fond_Info_Iphone];
_ctrl_Image ctrlSetPosition [0.39,0.04,0.13,0.05];
_ctrl_Image ctrlSetText "MRP_Telephones\Data\Menu_Principal\Icone_Batterie_dxt5.paa";
_ctrl_Image ctrlCommit 0;
