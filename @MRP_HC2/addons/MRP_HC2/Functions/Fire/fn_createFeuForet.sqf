/*
    ...
    Author: NiiRoZz
    Desc: Cree un incendie de foret sur HC2
*/
params [
    ["_pos",[],[[]]]
];

// Initialiser ALF_allAmbianceFeux si non defini
if (isNil "ALF_allAmbianceFeux") then { ALF_allAmbianceFeux = []; };

// Si un incendie de foret est deja en cours, ne pas en creer un autre
...
["INCENDIE","ALERTE INCENDIE !! DEPART D'INCENDIE DANS UNE FORET !!"] remoteExecCall ["ALF_Server_fnc_doMedCall", 2];
...
for "_i" from 1 to 9 do {
    // Verifier qu'il reste des arbres disponibles
    if (_alltress isEqualTo []) exitWith {};
...
[] spawn MRP_HC2_fnc_ambientFire;

[] spawn MRP_HC2_fnc_expansionFire;
