...
class pianomenu {
  ...
  class controls {
    ...
    class Btn02ColorMenuPiano: Life_RscButtonMenu {
      ...
      w = 0.058 * safezoneW;
      h = 0.1 * safezoneH;
      onButtonClick = "playsound ""Click1""; profileNamespace setVariable [""PianoColor"",2]; saveProfileNamespace;  ((uiNamespace getVariable ""pianomenu"")displayCtrl 0505) ctrlSetBackgroundColor [1, 0, 0, 1]; ((uiNamespace getVariable ""pianomenu"")displayCtrl 0800) ctrlSetTextColor [1, 0, 0, 1]; ((uiNamespace getVariable ""pianomenu"")displayCtrl 0900) ctrlSetTextColor [1, 0, 0, 1]; [] spawn ALF_fnc_overselectedColorMenu;";
      onMouseEnter = "playsound ""Click2""; [] spawn ALF_fnc_overColorMenu; player setVariable [""MouseOverButtonColorMenu"",2];";
      onMouseExit = "player setVariable [""MouseOverButtonColorMenu"",0];";
      colorBackgroundFocused[] = {1,1,1,0};
      colorBackground2[] = {0.75,0.75,0.75,0};
      color[] = {1,1,1,0};
    ...
    class Btn03ColorMenuPiano: Life_RscButtonMenu {
      ...
      w = 0.058 * safezoneW;
      h = 0.1 * safezoneH;
      onButtonClick = "playsound ""Click1""; profileNamespace setVariable [""PianoColor"",3]; saveProfileNamespace; ((uiNamespace getVariable ""pianomenu"")displayCtrl 0505) ctrlSetBackgroundColor [1, 0.3320, 0, 1]; ((uiNamespace getVariable ""pianomenu"")displayCtrl 0800) ctrlSetTextColor [1, 0.3320, 0, 1]; ((uiNamespace getVariable ""pianomenu"")displayCtrl 0900) ctrlSetTextColor [1, 0.3320, 0, 1]; [] spawn ALF_fnc_overselectedColorMenu;";
      onMouseEnter = "playsound ""Click2""; [] spawn ALF_fnc_overColorMenu; player setVariable [""MouseOverButtonColorMenu"",3];";
      onMouseExit = "player setVariable [""MouseOverButtonColorMenu"",0];";
      colorBackgroundFocused[] = {1,1,1,0};
      colorBackground2[] = {0.75,0.75,0.75,0};
      color[] = {1,1,1,0};
    ...
    class Btn04ColorMenuPiano: Life_RscButtonMenu {
      ...
      w = 0.058 * safezoneW;
      h = 0.1 * safezoneH;
      onButtonClick = "playsound ""Click1""; profileNamespace setVariable [""PianoColor"",4]; saveProfileNamespace; ((uiNamespace getVariable ""pianomenu"")displayCtrl 0505) ctrlSetBackgroundColor [1, 0.6640, 0, 1]; ((uiNamespace getVariable ""pianomenu"")displayCtrl 0800) ctrlSetTextColor [1, 0.6640, 0, 1]; ((uiNamespace getVariable ""pianomenu"")displayCtrl 0900) ctrlSetTextColor [1, 0.6640, 0, 1]; [] spawn ALF_fnc_overselectedColorMenu;";
      onMouseEnter = "playsound ""Click2""; [] spawn ALF_fnc_overColorMenu; player setVariable [""MouseOverButtonColorMenu"",4];";
      onMouseExit = "player setVariable [""MouseOverButtonColorMenu"",0];";
      colorBackgroundFocused[] = {1,1,1,0};
      colorBackground2[] = {0.75,0.75,0.75,0};
      color[] = {1,1,1,0};
	...
	*/
    ...
    class Btn05ColorMenuPiano: Life_RscButtonMenu {
      ...
      w = 0.058 * safezoneW;
      h = 0.1 * safezoneH;
      onButtonClick = "playsound ""Click1""; profileNamespace setVariable [""PianoColor"",5]; saveProfileNamespace; ((uiNamespace getVariable ""pianomenu"")displayCtrl 0505) ctrlSetBackgroundColor [1, 1, 0, 1]; ((uiNamespace getVariable ""pianomenu"")displayCtrl 0800) ctrlSetTextColor [1, 1, 0, 1]; ((uiNamespace getVariable ""pianomenu"")displayCtrl 0900) ctrlSetTextColor [1, 1, 0, 1]; [] spawn ALF_fnc_overselectedColorMenu;";
      onMouseEnter = "playsound ""Click2""; [] spawn ALF_fnc_overColorMenu; player setVariable [""MouseOverButtonColorMenu"",5];";
      onMouseExit = "player setVariable [""MouseOverButtonColorMenu"",0];";
      colorBackgroundFocused[] = {1,1,1,0};
      colorBackground2[] = {0.75,0.75,0.75,0};
      color[] = {1,1,1,0};
    ...
    class Btn06ColorMenuPiano: Life_RscButtonMenu {
      ...
      w = 0.058 * safezoneW;
      h = 0.1 * safezoneH;
      onButtonClick = "playsound ""Click1""; profileNamespace setVariable [""PianoColor"",6]; saveProfileNamespace; ((uiNamespace getVariable ""pianomenu"")displayCtrl 0505) ctrlSetBackgroundColor [0.6640, 1, 0, 1]; ((uiNamespace getVariable ""pianomenu"")displayCtrl 0800) ctrlSetTextColor [0.6640, 1, 0, 1]; ((uiNamespace getVariable ""pianomenu"")displayCtrl 0900) ctrlSetTextColor [0.6640, 1, 0, 1]; [] spawn ALF_fnc_overselectedColorMenu;";
      onMouseEnter = "playsound ""Click2""; [] spawn ALF_fnc_overColorMenu; player setVariable [""MouseOverButtonColorMenu"",6];";
      onMouseExit = "player setVariable [""MouseOverButtonColorMenu"",0];";
      colorBackgroundFocused[] = {1,1,1,0};
      colorBackground2[] = {0.75,0.75,0.75,0};
      color[] = {1,1,1,0};
    ...
    class Btn07ColorMenuPiano: Life_RscButtonMenu {
      ...
      w = 0.058 * safezoneW;
      h = 0.1 * safezoneH;
      onButtonClick = "playsound ""Click1""; profileNamespace setVariable [""PianoColor"",7]; saveProfileNamespace; ((uiNamespace getVariable ""pianomenu"")displayCtrl 0505) ctrlSetBackgroundColor [0, 1, 0, 1]; ((uiNamespace getVariable ""pianomenu"")displayCtrl 0800) ctrlSetTextColor [0, 1, 0, 1]; ((uiNamespace getVariable ""pianomenu"")displayCtrl 0900) ctrlSetTextColor [0, 1, 0, 1]; [] spawn ALF_fnc_overselectedColorMenu;";
      onMouseEnter = "playsound ""Click2""; [] spawn ALF_fnc_overColorMenu; player setVariable [""MouseOverButtonColorMenu"",7];";
      onMouseExit = "player setVariable [""MouseOverButtonColorMenu"",0];";
      colorBackgroundFocused[] = {1,1,1,0};
      colorBackground2[] = {0.75,0.75,0.75,0};
      color[] = {1,1,1,0};
    ...
    class Btn08ColorMenuPiano: Life_RscButtonMenu {
      ...
      w = 0.058 * safezoneW;
      h = 0.1 * safezoneH;
      onButtonClick = "playsound ""Click1""; profileNamespace setVariable [""PianoColor"",8]; saveProfileNamespace; ((uiNamespace getVariable ""pianomenu"")displayCtrl 0505) ctrlSetBackgroundColor [0, 1, 0.3320, 1]; ((uiNamespace getVariable ""pianomenu"")displayCtrl 0800) ctrlSetTextColor [0, 1, 0.3320, 1];  ((uiNamespace getVariable ""pianomenu"")displayCtrl 0900) ctrlSetTextColor [0, 1, 0.3320, 1]; [] spawn ALF_fnc_overselectedColorMenu;";
      onMouseEnter = "playsound ""Click2""; [] spawn ALF_fnc_overColorMenu; player setVariable [""MouseOverButtonColorMenu"",8];";
      onMouseExit = "player setVariable [""MouseOverButtonColorMenu"",0];";
      colorBackgroundFocused[] = {1,1,1,0};
      colorBackground2[] = {0.75,0.75,0.75,0};
      color[] = {1,1,1,0};
    ...
    class Btn09ColorMenuPiano: Life_RscButtonMenu {
      ...
      w = 0.058 * safezoneW;
      h = 0.1 * safezoneH;
      onButtonClick = "playsound ""Click1""; profileNamespace setVariable [""PianoColor"",9]; saveProfileNamespace; ((uiNamespace getVariable ""pianomenu"")displayCtrl 0505) ctrlSetBackgroundColor [0, 1, 0.6640, 1]; ((uiNamespace getVariable ""pianomenu"")displayCtrl 0800) ctrlSetTextColor [0, 1, 0.6640, 1]; ((uiNamespace getVariable ""pianomenu"")displayCtrl 0900) ctrlSetTextColor [0, 1, 0.6640, 1]; [] spawn ALF_fnc_overselectedColorMenu;";
      onMouseEnter = "playsound ""Click2""; [] spawn ALF_fnc_overColorMenu; player setVariable [""MouseOverButtonColorMenu"",9];";
      onMouseExit = "player setVariable [""MouseOverButtonColorMenu"",0];";
      colorBackgroundFocused[] = {1,1,1,0};
      colorBackground2[] = {0.75,0.75,0.75,0};
      color[] = {1,1,1,0};
    ...
    class Btn10ColorMenuPiano: Life_RscButtonMenu {
      ...
      w = 0.058 * safezoneW;
      h = 0.1 * safezoneH;
      onButtonClick = "playsound ""Click1""; profileNamespace setVariable [""PianoColor"",10]; saveProfileNamespace; ((uiNamespace getVariable ""pianomenu"")displayCtrl 0505) ctrlSetBackgroundColor [0, 1, 1, 1]; ((uiNamespace getVariable ""pianomenu"")displayCtrl 0800) ctrlSetTextColor [0, 1, 1, 1]; ((uiNamespace getVariable ""pianomenu"")displayCtrl 0900) ctrlSetTextColor [0, 1, 1, 1]; [] spawn ALF_fnc_overselectedColorMenu;";
      onMouseEnter = "playsound ""Click2""; [] spawn ALF_fnc_overColorMenu; player setVariable [""MouseOverButtonColorMenu""10];";
      onMouseExit = "player setVariable [""MouseOverButtonColorMenu"",0];";
      colorBackgroundFocused[] = {1,1,1,0};
      colorBackground2[] = {0.75,0.75,0.75,0};
      color[] = {1,1,1,0};
    ...
    class Btn11ColorMenuPiano: Life_RscButtonMenu {
      ...
      w = 0.058 * safezoneW;
      h = 0.1 * safezoneH;
      onButtonClick = "playsound ""Click1""; profileNamespace setVariable [""PianoColor"",11]; saveProfileNamespace; ((uiNamespace getVariable ""pianomenu"")displayCtrl 0505) ctrlSetBackgroundColor [0, 0.6640, 1, 1]; ((uiNamespace getVariable ""pianomenu"")displayCtrl 0800) ctrlSetTextColor [0, 0.6640, 1, 1]; ((uiNamespace getVariable ""pianomenu"")displayCtrl 0900) ctrlSetTextColor [0, 0.6640, 1, 1]; [] spawn ALF_fnc_overselectedColorMenu;";
      onMouseEnter = "playsound ""Click2""; [] spawn ALF_fnc_overColorMenu; player setVariable [""MouseOverButtonColorMenu"",11];";
      onMouseExit = "player setVariable [""MouseOverButtonColorMenu"",0];";
      colorBackgroundFocused[] = {1,1,1,0};
      colorBackground2[] = {0.75,0.75,0.75,0};
      color[] = {1,1,1,0};
    ...
    class Btn12ColorMenuPiano: Life_RscButtonMenu {
      ...
      w = 0.058 * safezoneW;
      h = 0.1 * safezoneH;
      onButtonClick = "playsound ""Click1""; profileNamespace setVariable [""PianoColor"",12]; saveProfileNamespace; ((uiNamespace getVariable ""pianomenu"")displayCtrl 0505) ctrlSetBackgroundColor [0, 0.3320, 1, 1]; ((uiNamespace getVariable ""pianomenu"")displayCtrl 0800) ctrlSetTextColor [0, 0.3320, 1, 1]; ((uiNamespace getVariable ""pianomenu"")displayCtrl 0900) ctrlSetTextColor [0, 0.3320, 1, 1]; [] spawn ALF_fnc_overselectedColorMenu;";
      onMouseEnter = "playsound ""Click2""; [] spawn ALF_fnc_overColorMenu; player setVariable [""MouseOverButtonColorMenu"",12];";
      onMouseExit = "player setVariable [""MouseOverButtonColorMenu"",0];";
      colorBackgroundFocused[] = {1,1,1,0};
      colorBackground2[] = {0.75,0.75,0.75,0};
      color[] = {1,1,1,0};
    ...
    class Btn13ColorMenuPiano: Life_RscButtonMenu {
      ...
      w = 0.058 * safezoneW;
      h = 0.1 * safezoneH;
      onButtonClick = "playsound ""Click1""; profileNamespace setVariable [""PianoColor"",13]; saveProfileNamespace; ((uiNamespace getVariable ""pianomenu"")displayCtrl 0505) ctrlSetBackgroundColor [0, 0, 1, 1]; ((uiNamespace getVariable ""pianomenu"")displayCtrl 0800) ctrlSetTextColor [0, 0, 1, 1]; ((uiNamespace getVariable ""pianomenu"")displayCtrl 0900) ctrlSetTextColor [0, 0, 1, 1]; [] spawn ALF_fnc_overselectedColorMenu;";
      onMouseEnter = "playsound ""Click2""; [] spawn ALF_fnc_overColorMenu; player setVariable [""MouseOverButtonColorMenu"",13];";
      onMouseExit = "player setVariable [""MouseOverButtonColorMenu"",0];";
      colorBackgroundFocused[] = {1,1,1,0};
      colorBackground2[] = {0.75,0.75,0.75,0};
      color[] = {1,1,1,0};
    ...
    class Btn14ColorMenuPiano: Life_RscButtonMenu {
      ...
      w = 0.058 * safezoneW;
      h = 0.1 * safezoneH;
      onButtonClick = "playsound ""Click1""; profileNamespace setVariable [""PianoColor"",14]; saveProfileNamespace; ((uiNamespace getVariable ""pianomenu"")displayCtrl 0505) ctrlSetBackgroundColor [0.3320, 0, 1, 1]; ((uiNamespace getVariable ""pianomenu"")displayCtrl 0800) ctrlSetTextColor [0.3320, 0, 1, 1]; ((uiNamespace getVariable ""pianomenu"")displayCtrl 0900) ctrlSetTextColor [0.3320, 0, 1, 1]; [] spawn ALF_fnc_overselectedColorMenu;";
      onMouseEnter = "playsound ""Click2""; [] spawn ALF_fnc_overColorMenu; player setVariable [""MouseOverButtonColorMenu"",14];";
      onMouseExit = "player setVariable [""MouseOverButtonColorMenu"",0];";
      colorBackgroundFocused[] = {1,1,1,0};
      colorBackground2[] = {0.75,0.75,0.75,0};
      color[] = {1,1,1,0};
   ...
   /* class BtnOverA15BackColorMenuPiano: Life_RscText {
    ...
    class Btn15ColorMenuPiano: Life_RscButtonMenu {
      ...
      w = 0.058 * safezoneW;
      h = 0.1 * safezoneH;
      onButtonClick = "playsound ""Click1""; profileNamespace setVariable [""PianoColor"",15]; saveProfileNamespace; ((uiNamespace getVariable ""pianomenu"")displayCtrl 0505) ctrlSetBackgroundColor [0.6640, 0, 1, 1]; ((uiNamespace getVariable ""pianomenu"")displayCtrl 0800) ctrlSetTextColor [0.6640, 0, 1, 1]; ((uiNamespace getVariable ""pianomenu"")displayCtrl 0900) ctrlSetTextColor [0.6640, 0, 1, 1]; [] spawn ALF_fnc_overselectedColorMenu;";
      onMouseEnter = "playsound ""Click2""; [] spawn ALF_fnc_overColorMenu; player setVariable [""MouseOverButtonColorMenu"",15];";
      onMouseExit = "player setVariable [""MouseOverButtonColorMenu"",0];";
      colorBackgroundFocused[] = {1,1,1,0};
      colorBackground2[] = {0.75,0.75,0.75,0};
      color[] = {1,1,1,0};
    ...
    class Btn16ColorMenuPiano: Life_RscButtonMenu {
      ...
      w = 0.058 * safezoneW;
      h = 0.1 * safezoneH;
      onButtonClick = "playsound ""Click1""; profileNamespace setVariable [""PianoColor"",16]; saveProfileNamespace; ((uiNamespace getVariable ""pianomenu"")displayCtrl 0505) ctrlSetBackgroundColor [1, 0, 1, 1]; ((uiNamespace getVariable ""pianomenu"")displayCtrl 0800) ctrlSetTextColor [1, 0, 1, 1]; ((uiNamespace getVariable ""pianomenu"")displayCtrl 0900) ctrlSetTextColor [1, 0, 1, 1]; [] spawn ALF_fnc_overselectedColorMenu;";
      onMouseEnter = "playsound ""Click2""; [] spawn ALF_fnc_overColorMenu; player setVariable [""MouseOverButtonColorMenu"",16];";
      onMouseExit = "player setVariable [""MouseOverButtonColorMenu"",0];";
      colorBackgroundFocused[] = {1,1,1,0};
      colorBackground2[] = {0.75,0.75,0.75,0};
      color[] = {1,1,1,0};
    ...
    class Btn17ColorMenuPiano: Life_RscButtonMenu {
      ...
      w = 0.058 * safezoneW;
      h = 0.1 * safezoneH;
      onButtonClick = "playsound ""Click1""; profileNamespace setVariable [""PianoColor"",17]; saveProfileNamespace; ((uiNamespace getVariable ""pianomenu"")displayCtrl 0505) ctrlSetBackgroundColor [1, 0, 0.6640, 1]; ((uiNamespace getVariable ""pianomenu"")displayCtrl 0800) ctrlSetTextColor [1, 0, 0.6640, 1]; ((uiNamespace getVariable ""pianomenu"")displayCtrl 0900) ctrlSetTextColor [1, 0, 0.6640, 1]; [] spawn ALF_fnc_overselectedColorMenu;";
      onMouseEnter = "playsound ""Click2""; [] spawn ALF_fnc_overColorMenu; player setVariable [""MouseOverButtonColorMenu"",17];";
      onMouseExit = "player setVariable [""MouseOverButtonColorMenu"",0];";
      colorBackgroundFocused[] = {1,1,1,0};
      colorBackground2[] = {0.75,0.75,0.75,0};
      color[] = {1,1,1,0};
   ...
   /* class BtnOverA18BackColorMenuPiano: Life_RscText {
    ...
    class Btn18ColorMenuPiano: Life_RscButtonMenu {
      ...
      w = 0.058 * safezoneW;
      h = 0.1 * safezoneH;
      onButtonClick = "playsound ""Click1""; profileNamespace setVariable [""PianoColor"",18]; saveProfileNamespace; ((uiNamespace getVariable ""pianomenu"")displayCtrl 0505) ctrlSetBackgroundColor [1, 0, 0.3320, 1]; ((uiNamespace getVariable ""pianomenu"")displayCtrl 0800) ctrlSetTextColor [1, 0, 0.3320, 1]; ((uiNamespace getVariable ""pianomenu"")displayCtrl 0900) ctrlSetTextColor [1, 0, 0.3320, 1]; [] spawn ALF_fnc_overselectedColorMenu;";
      onMouseEnter = "playsound ""Click2""; [] spawn ALF_fnc_overColorMenu; player setVariable [""MouseOverButtonColorMenu"",18];";
      onMouseExit = "player setVariable [""MouseOverButtonColorMenu"",0];";
      colorBackgroundFocused[] = {1,1,1,0};
      colorBackground2[] = {0.75,0.75,0.75,0};
      color[] = {1,1,1,0};
    ...
    class Btn19ColorMenuPiano: Life_RscButtonMenu {
      ...
      w = 0.058 * safezoneW;
      h = 0.1 * safezoneH;
      onButtonClick = "playsound ""Click1""; profileNamespace setVariable [""PianoColor"",19]; saveProfileNamespace; ((uiNamespace getVariable ""pianomenu"")displayCtrl 0505) ctrlSetBackgroundColor [0.5, 0.5, 0.5, 1]; ((uiNamespace getVariable ""pianomenu"")displayCtrl 0800) ctrlSetTextColor [0.5, 0.5, 0.5, 1]; ((uiNamespace getVariable ""pianomenu"")displayCtrl 0900) ctrlSetTextColor [0.5, 0.5, 0.5, 1]; [] spawn ALF_fnc_overselectedColorMenu;";
      onMouseEnter = "playsound ""Click2""; [] spawn ALF_fnc_overColorMenu; player setVariable [""MouseOverButtonColorMenu"",19];";
      onMouseExit = "player setVariable [""MouseOverButtonColorMenu"",0];";
      colorBackgroundFocused[] = {1,1,1,0};
      colorBackground2[] = {0.75,0.75,0.75,0};
      color[] = {1,1,1,0};
    ...
    class Btn20ColorMenuPiano: Life_RscButtonMenu {
      ...
      w = 0.058 * safezoneW;
      h = 0.1 * safezoneH;
      onButtonClick = "playsound ""Click1""; profileNamespace setVariable [""PianoColor"",20]; saveProfileNamespace; ((uiNamespace getVariable ""pianomenu"")displayCtrl 0505) ctrlSetBackgroundColor [0, 0, 0, 1]; ((uiNamespace getVariable ""pianomenu"")displayCtrl 0800) ctrlSetTextColor [0, 0, 0, 1]; ((uiNamespace getVariable ""pianomenu"")displayCtrl 0900) ctrlSetTextColor [0, 0, 0, 1]; [] spawn ALF_fnc_overselectedColorMenu;";
      onMouseEnter = "playsound ""Click2""; [] spawn ALF_fnc_overColorMenu; player setVariable [""MouseOverButtonColorMenu"",20];";
      onMouseExit = "player setVariable [""MouseOverButtonColorMenu"",0];";
      colorBackgroundFocused[] = {1,1,1,0};
      colorBackground2[] = {0.75,0.75,0.75,0};
      color[] = {1,1,1,0};
   ...
   /* class BtnChoosenTexBackColorMenuPiano: Life_RscText {
    ...
    class BtnDisabledColorMenuPiano: Life_RscPicture { // image derrière le bouton
      idc = 0805;
      colorBackground[] = { 0, 0, 0, 1};
      text = "\ALF_Client2\piano\images\DisabledTexture.paa";
    ...
    class BtnTexpictureColorMenuPiano: Life_RscPicture { // image derrière le bouton
      idc = 0800;
      colorBackground[] = { 0, 0, 0, 1};
      text = "\ALF_Client2\piano\images\TextureImgSimpleCM.paa";
      x = 0.503 * safezoneW + safezoneX; // x du 13eme,  le y du 20ème, le w du 13 et 14 assembler + espace, hauteur inchangé  (x14 + w14) - x13
      y = 0.425 * safezoneH + safezoneY;
      w = 0.134 * safezoneW;
      h = 0.237 * safezoneH;
    ...
    class BtnCustomBackColorMenuPiano: Life_RscPicture {
      idc = 0900;
      colorBackground[] = { 1, 1, 1, 1};
      text = "\ALF_Client2\piano\images\CustomImgSimpleCM.paa";
      x = 0.639 * safezoneW + safezoneX;
      y = 0.425 * safezoneH + safezoneY;
      w = 0.134 * safezoneW;
      h = 0.237 * safezoneH;
    ...
    class BtnCustomColorMenuPiano: Life_RscButtonMenu {
      ...
      w = 0.126 * safezoneW;
      h = 0.1 * safezoneH;
      onButtonClick = "playsound ""Click1""; profileNamespace setVariable [""PianoColor"",21]; saveProfileNamespace; [] spawn ALF_fnc_overselectedColorMenu; [] spawn ALF_fnc_customColorMenu;";
			onMouseEnter = "playsound ""Click2"";";
      onMouseExit = "";
      colorBackgroundFocused[] = {1,1,1,0};
      colorBackground2[] = {0.75,0.75,0.75,0};
    ...
    class BackgroundTextSheetPiano : Life_RscControlsGroup {
      ...
      idc = 0101;
      text = "\ALF_Client2\piano\images\WhiteKey.paa";
    ...
    class BlackKey01Piano: Life_RscPicture {
      idc = 0201;
      colorBackground[] = { 1, 1, 1, 1};
      text = "\ALF_Client2\piano\images\BlackKey.paa";
