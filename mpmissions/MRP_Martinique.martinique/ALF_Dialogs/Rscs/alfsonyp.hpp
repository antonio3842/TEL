...
class ALF_SonyP_Dialog {
	...
	onLoad = "uiNamespace setVariable ['sonyp',0]; [] spawn { waitUntil {!isNull (findDisplay 38999)}; private _d = findDisplay 38999; { private _c = _d displayCtrl _x; if (!isNull _c) then {_c ctrlShow false}; } forEach [682580,682581,682582,682583,682585]; };";
	movingEnable = true;
	...
	class controls {
		...
		class SonyMenuBtnUber : Life_RscButtonInvisible {
			idc = 39155;
			text = "";
			onButtonClick = "uiNamespace setVariable ['sonyp',14]; [] call ALF_fnc_menuSonyP;";
