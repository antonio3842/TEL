...
class xpmenu {
	...
	class controls {
		class FondRecolte: Life_RscPicture {
			idc = 98760;
			text = "\ALF_Client2\textures\XP\menurecolte1.paa";
			x = 0.288594 * safezoneW + safezoneX;
			y = 0.115 * safezoneH + safezoneY;
			w = 0.417656 * safezoneW;
			h = 0.759 * safezoneH;
		...
		class FondPeche: Life_RscPicture {
			idc = 98762;
			text = "\ALF_Client2\textures\XP\menupeche1.paa";
			x = 0.288594 * safezoneW + safezoneX;
			y = 0.115 * safezoneH + safezoneY;
			w = 0.417656 * safezoneW;
			h = 0.759 * safezoneH;
		...
		class FondIllegal: Life_RscPicture {
			idc = 98763;
			text = "\ALF_Client2\textures\XP\menuillegale1.paa";
			x = 0.288594 * safezoneW + safezoneX;
			y = 0.115 * safezoneH + safezoneY;
			w = 0.417656 * safezoneW;
			h = 0.759 * safezoneH;
		...
		*/
		class TXT_Xp: Life_RscStructuredText {
			idc = 98768;
			text = "";
			x = 0.588568 * safezoneW + safezoneX;
