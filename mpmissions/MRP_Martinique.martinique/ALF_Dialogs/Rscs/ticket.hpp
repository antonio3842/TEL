...
class Life_fiche_paie {
	idd = 3750156;
	name = "Life_fiche_paie";
	movingEnable = 0;
	enableSimulation = 1;
	...
	class controls {
		class Title: Life_RscTitle {
			colorBackground[] = {0, 0, 0, 0};
			idc = 3750157;
			text = "Menu pour faire une fiche de paie";
			x = 0.3;
			y = 0.2;
			w = 0.6;
			h = (1 / 25);
		...
		class fiche_paie_Edit: Life_RscEdit {
			idc = 3750158;
			text = "1";
			sizeEx = 0.030;
			x = 0.40;
		...
		class fiche_paie_Btn: Life_RscButtonMenu {
			idc = 3750159;
			text = "Confirmer";
			colorBackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", 0.5};
			onButtonClick = "[0,ctrlText 3750158] call ALF_fnc_ticketEntreprise";
			x = 0.45;
			y = 0.35;
			w = (6.25 / 40);
			h = (1 / 25);
