...
class Life_impound_menu {
	...
	class controlsBackground {
		...
		class SellCar: Life_RscButtonMenu {
			idc = 97483;
			text = "VENDRE";
			onButtonClick = "[] spawn ALF_fnc_sellGarage;";
	...
	class controls {
		class VehicleList: Life_RscListBox {
			...
			onLBSelChanged = "_this call ALF_fnc_garageLBChange;";
			x = 0.11;
			y = 0.302;
			w = 0.303;
			h = 0.49;
...
class Life_impound_menuCopSP {
	...
	class controls {
		class VehicleList: Life_RscListBox {
			...
			sizeEx = 0.04;
			colorBackground[] = {0.1,0.1,0.1,0.9};
			onLBSelChanged = "_this call ALF_fnc_garageLBChangeCopSP;";
			x = 0.11;
			y = 0.302;
			w = 0.303;
			h = 0.49;
...
class Life_impound_menuv3 {
	...
	class controlsBackground {
		...
		class RetrieveCar: Life_RscButtonMenu {
			idc = -1;
			text = "SORTIR";
			onButtonClick = "[] spawn MRPV2_fnc_Vehicule_Fourriere_Sortir;";
			x = 0.1 + (6.25 / 40) + (1 / 250 / (safezoneW / safezoneH));
			y = 0.9 - (1 / 25);
			w = (6.25 / 40);
			h = (1 / 25);
	...
	class controls {
		class VehicleList: Life_RscListBox {
			...
			sizeEx = 0.04;
			colorBackground[] = {0.1,0.1,0.1,0.9};
			onLBSelChanged = "_this call ALF_fnc_garageLBChangeLock;";
			x = 0.11;
			y = 0.302;
			w = 0.303;
			h = 0.49;
...
class Life_impound_menuPenit {
	idd = 080520;
	name="Life_impound_menuPenit";
	movingEnable = 0;
	enableSimulation = 1;
	onLoad = "ctrlShow [2330,false];";
	...
	class controls {
		class VehicleList: Life_RscListBox {
			...
			sizeEx = 0.04;
			colorBackground[] = {0.1,0.1,0.1,0.9};
			onLBSelChanged = "_this call ALF_fnc_garageLBChangePenit;";
			x = 0.11;
			y = 0.302;
			w = 0.303;
			h = 0.49;
