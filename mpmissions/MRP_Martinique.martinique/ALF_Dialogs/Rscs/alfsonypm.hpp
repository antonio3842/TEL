...
*/
class ALF_SonyPM_Dialog {
	idd = 20520;
	name= "ALF_SonyPM_Dialog";
	onLoad = "uiNamespace setVariable ['sonypm',0]; [] spawn { waitUntil {!isNull (findDisplay 20520)}; private _d = findDisplay 20520; { private _c = _d displayCtrl _x; if (!isNull _c) then {_c ctrlShow false}; } forEach [682580,682581,682582,682583,682585]; };";
	movingEnable = true;
	...
	class controls {
		class SonyMenu : Life_RscPicture {
			idc = 39001;
			text = "\ALF_Client2\textures\SonyPM\Sony_Menu.paa";
		...
		class SonyRadio : Life_RscPicture {
			idc = 39036;
			text = "\ALF_Client2\textures\SonyPM\Sony_Radio.paa";
			x = 0.200937 * safezoneW + safezoneX;
			y = 0.027 * safezoneH + safezoneY;
			w = 0.587812 * safezoneW;
			h = 1 * safezoneH;
		...
		class SonyCentral : Life_RscPicture {
			idc = 39120;
			text = "\ALF_Client2\textures\SonyPM\Sony_Central.paa";
			x = 0.200937 * safezoneW + safezoneX;
			y = 0.027 * safezoneH + safezoneY;
			w = 0.587812 * safezoneW;
			h = 1 * safezoneH;
		...
		class SonyMessagesLb : Life_RscListBox {
			...
			font = "HelveticaLTLight";
			sizeEx = 0.035;
			onLBSelChanged = "call ALF_fnc_lbChangedSmsSonyPM;";
			x = 0.267708 * safezoneW + safezoneX;
		...
		class SonyTaxiCallLabel : Life_RscText {
			idc = 682582;
			style = 2;
			shadow = 0;
		...
		class SonyTaxiCallHit : Life_RscButtonInvisible {
			idc = 682585;
			text = "";
			x = 0.41 * safezoneW + safezoneX;
			y = 0.70 * safezoneH + safezoneY;
		...
		class SonyMenuBtnUber : Life_RscButtonInvisible {
			idc = 39155;
			text = "";
			onButtonClick = "uiNamespace setVariable ['sonypm',14]; [] call ALF_fnc_menuSonyPM;";
			x = 0.222 * safezoneW + safezoneX;
		...
		class HomeBtn : Life_RscButtonInvisible {
			idc = 39000;
			text = "";
			onButtonClick = "uiNamespace setVariable ['sonypm',0]; call ALF_fnc_menuSonyPM;";
