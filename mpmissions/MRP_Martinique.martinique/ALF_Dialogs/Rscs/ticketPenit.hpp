...
*/
class Life_ticket_givePenit {
	idd = 050520;
	name = "Life_ticket_givePenit";
	movingEnable = 0;
	enableSimulation = 1;
	...
	class controls {
		...
		class payTicket: Life_RscButtonMenu {
			...
			onButtonClick = "[] call ALF_fnc_ticketGivePenit";
			x = 0.45;
			y = 0.35;
			w = (6.25 / 40);
			h = (1 / 25);
...
class life_ticket_payPenit {
	idd = 0505201;
	name = "life_ticket_payPenit";
	movingEnable = 0;
	enableSimulation = 1;
	...
	class controls {
		...
		class payTicket: Life_RscButtonMenu {
			...
			colorBackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", 0.5};
			onButtonClick = "[] call ALF_fnc_ticketPayPenit;";
