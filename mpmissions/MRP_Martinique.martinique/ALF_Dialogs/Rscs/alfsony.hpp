...
class ALF_Sony_Dialog {
	...
	onLoad = "uiNamespace setVariable ['sony',0]; [] spawn { waitUntil {!isNull (findDisplay 32999)}; private _d = findDisplay 32999; { private _c = _d displayCtrl _x; if (!isNull _c) then {_c ctrlShow false}; } forEach [682580,682581,682582,682583,682585]; };";
	movingEnable = true;
	...
	class controls {
		...
		class SonyMenuBtnUber : Life_RscButtonInvisible {
			idc = 33192;
			text = "";
			onButtonClick = "uiNamespace setVariable ['sony',19]; [] call ALF_fnc_menuSony;";
