...
class pokerHUD {
	...
	class controls {
		// Texte info croupier (au-dessus des cartes) — BJ uniquement, caché par défaut
		class bjDealerInfo : Life_RscText {
			idc = 544159;
			show = 0;
			text = "";
		...
		// Texte score joueur (au-dessus des cartes) — BJ uniquement, caché par défaut
		class bjPlayerScore : Life_RscText {
			idc = 544158;
			show = 0;
			text = "";
			x = 0.01 * safezoneW + safezoneX;
		...
		class carte3 : Life_RscPicture {
			idc = 544153;
			text = "";
			x = 0.202569 * safezoneW + safezoneX;
			y = 0.676 * safezoneH + safezoneY;
			w = 0.0902083 * safezoneW;
			h = 0.34852 * safezoneH;
		};
		class carte4 : Life_RscPicture {
			idc = 544154;
			text = "";
			x = 0.298869 * safezoneW + safezoneX;
			y = 0.6749 * safezoneH + safezoneY;
			w = 0.0902083 * safezoneW;
			h = 0.34852 * safezoneH;
		};
		class carte5 : Life_RscPicture {
			idc = 544155;
			text = "";
			x = 0.395169 * safezoneW + safezoneX;
			y = 0.676 * safezoneH + safezoneY;
			w = 0.0902083 * safezoneW;
			h = 0.34852 * safezoneH;
		};
		class carte6 : Life_RscPicture {
			idc = 544156;
			text = "";
			x = 0.491469 * safezoneW + safezoneX;
			y = 0.6749 * safezoneH + safezoneY;
			w = 0.0902083 * safezoneW;
			h = 0.34852 * safezoneH;
		};
		class carte7 : Life_RscPicture {
			idc = 544157;
			text = "";
			x = 0.587769 * safezoneW + safezoneX;
			y = 0.676 * safezoneH + safezoneY;
			w = 0.0902083 * safezoneW;
			h = 0.34852 * safezoneH;
		};
