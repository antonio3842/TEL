...
player createDiaryRecord ["credits",
	[
		"Martinique Roleplay",
			"
				Martinique Roleplay et basé sur le framework roleplay ALF développé par ALF Team et MRP sur une base de jeu d'Altis Life RPG.<br/><br/>

				L'ensemble des fichiers scriptés par ALF Team et MRP sont sous licences.<br/><br/>
